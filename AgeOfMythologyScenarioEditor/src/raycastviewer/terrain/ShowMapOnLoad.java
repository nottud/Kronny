...
public class ShowMapOnLoad {
   ...
   public ShowMapOnLoad(RootModel rootModel, CameraConverter cameraConverter, GraphicsRedrawHander graphicsRedrawHander,
         Supplier<Double> displayWidthProvider, Supplier<Double> displayHeightProvider) {
