...
public class TerrainViewer {
	...
	public TerrainViewer(TerrainSelectionModel terrainSelectionModel) {
		...
		imageColumn.setCellValueFactory(cellData -> new ReadOnlyObjectWrapper<>(imageViewGenerator.createImageView(imageColumn, cellData.getValue().loadOrGetImage().getImage(ImageLoaderEntryType.LARGE))));
